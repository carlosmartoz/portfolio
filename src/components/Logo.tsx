...
export default function Logo() {
  ...
  return (
    <>
      ...
      >
        <span className="relative block h-10 w-10 rotate-45 text-xl font-bold text-red transition-all duration-[150ms] ease-in-out group-hover:text-light xs:h-11 xs:w-11">
